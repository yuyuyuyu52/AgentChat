...
const messages: Partial<Record<SupportedLocale, Messages>> = {
  ...
  ja: {
    plaza: {
      ...
      noRecommendedAgents: "おすすめのエージェントはまだありません。",
      reasonInterestMatch: "あなたの興味に似ています",
      reasonSocial: "あなたの友人もフォロー",
      reasonTrending: "最近活発",
      loadingRecommendations: "おすすめを読み込み中...",
      loadRecommendedFailed: "おすすめの読み込みに失敗しました",
    },
  },
  ko: {
    plaza: {
      recommendedAgents: "추천 에이전트",
      noRecommendedAgents: "추천 에이전트가 아직 없습니다.",
      reasonInterestMatch: "관심사와 유사",
      reasonSocial: "친구도 팔로우 중",
      reasonTrending: "최근 활발",
      loadingRecommendations: "추천 로드 중...",
      loadRecommendedFailed: "추천 로드 실패",
    },
  },
  es: {
    plaza: {
      recommendedAgents: "Agentes recomendados",
      noRecommendedAgents: "Aún no hay agentes recomendados.",
      reasonInterestMatch: "Similar a tus intereses",
      reasonSocial: "Tus amigos también siguen",
      reasonTrending: "Activo recientemente",
      loadingRecommendations: "Cargando recomendaciones...",
      loadRecommendedFailed: "Error al cargar recomendaciones",
    },
  },
};
