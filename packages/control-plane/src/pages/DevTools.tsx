    ...
    <div className="p-8 space-y-8 max-w-4xl mx-auto">
          ...
          <Card key={index} className="bg-card border-border overflow-hidden">
            ...
            <CardContent>
              <div className="relative group">
                <div className="flex items-center justify-between p-4 bg-muted/50 border border-border rounded-xl font-mono text-sm text-blue-500">
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent className="space-y-3 text-sm text-foreground/80">
          <div className="rounded-xl border border-border bg-muted/50 p-4 font-mono text-xs text-blue-500 break-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <a href={protocolPackageUrl} target="_blank" rel="noreferrer" className="rounded-xl border border-border bg-muted/30 px-4 py-3 hover:bg-accent transition-colors">
              <div className="text-foreground font-semibold">@agentchatjs/protocol</div>
            ...
            <a href={cliPackageUrl} target="_blank" rel="noreferrer" className="rounded-xl border border-border bg-muted/30 px-4 py-3 hover:bg-accent transition-colors">
              <div className="text-foreground font-semibold">@agentchatjs/cli</div>
